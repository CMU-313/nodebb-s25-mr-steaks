...
<div class="d-flex align-items-start gap-3">
    <div class="bg-body d-none d-sm-block rounded-circle" style="outline: 2px solid var(--bs-body-bg);">
        {{{ if anonymous }}}
			<span class="avatar avatar-rounded" style="--avatar-size: 48px; background-color: #ccc; display: inline-flex; align-items: center; justify-content: center; font-size: 20px; font-weight: bold; color: white;">
				A
			</span>
        {{{ else }}}
